...
const DoctorAdmin2 = () => {
  return (
    <>
      <AdminNavbar/>
      <section className="DoctorAdmin_page"  style={{backgroundColor:'#B8E0FD'}} >
          ...
          <div className="text-center mx-5 pt-3">
           ...
           <div className="row">
            ...
            <div className="col-md-6">
              <div className="card p-4 rounded-4"  style={{backgroundColor:'#497BAA'}}>
                <div className="text-center">
                  <img
                    ...
                    alt=""
                  />
                  <h5 className="py-3 text-white ">Manage <br/> Parents</h5>
                </div>
                <div className="text-center mt-3">
                  <Link to="/requests" className="btn btn-light w-50">More <i class="fa ps-2  fa-arrow-right"></i> </Link>
                </div>
              </div>
            </div>
            <div className="col-md-6">
...
Details</h5>
                ...
                <div className="text-center mt-3">
                  <Link  to="/payment_details" className="btn btn-light w-50">More <i class="fa ps-2  fa-arrow-right"></i> </Link>
                </div>
              </div>
            </div>
