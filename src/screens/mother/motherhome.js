            ...
            <div className="col-md-3">
              <div className="card p-4 rounded-4">
                ...
                <img
                    ...
                    alt=""
                  />
                  <h5 className="pt-2">Mother Diet Plan </h5>
                </div>
                ...
                <div className="text-center mt-3">
                 <Link to="/mother_dietPlan"> <button className="btn btn-light w-50">More  <i class="fa ps-2  fa-arrow-right"></i> </button></Link>
                </div>
              </div>
            </div>
            <div className="col-md-3">
              <div className="card p-4 rounded-4">
                <div className="text-center">
                  ...
                  <h5 className="pt-2">Qoutes for Mother</h5>
                </div>
                <div className="text-left">
                  <p> </p>
                  <p>
                ...
                <div className="text-center mt-3">
                  <Link to="/qoutes"><button style={{marginTop:"80px"}} className="btn btn-light w-50">More  <i class="fa ps-2  fa-arrow-right"></i> </button></Link>
                </div>
              </div>
            </div>
