...
const AdminLogin = () => {
 ...
 const handleInputs = (e) => {
  ...
  return (
    <div className="AdminLogin_page"style={{backgroundColor:'#C2FFFF'}} >
            ...
            <div>
              <form>
                <div className="row">
                  ...
                  <Link to="/home_admin_page"   style={{backgroundColor:'#00C8C8',fontSize:'20px',fontWeight:'700'}} className="btn text-white border-0 px-3 rounded-3 ">LOGIN</Link>
                  </div>
