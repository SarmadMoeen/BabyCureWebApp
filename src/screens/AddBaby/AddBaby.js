...
const AddBaby = () => {
  return (
    <>
      ...
      <section className="p-5" style={{backgroundColor:'#497BAA'}}>
          <div className="container p-4  text-center" style={{backgroundColor:'#D9D9D973'}}>
      ...
      <div className="py-5" style={{backgroundColor:'#C2FFFF'}}>
